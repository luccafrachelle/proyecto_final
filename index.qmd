...
1.  **Exponenciación:** Primero, se aplica la función exponencial a cada elemento de entrada ($e^{z_i}$). Esto convierte todos los números en positivos y, además, magnifica las diferencias entre ellos.
2.  **Normalización:** A continuación, se divide cada valor exponencial por la suma de todos los valores exponenciales. Este paso asegura que los valores resultantes estén en el rango de 0 a 1 y que su suma total sea 1.

**Ejemplo Numérico:**

Supongamos que un modelo de clasificación de imágenes arroja los siguientes *logits* para las clases "gato", "perro" y "pájaro":
...
**Ejemplo Numérico: La No Simetría de KL**
...
Como se observa, $\text{KL}(P || Q) \approx 0.2455$ y $\text{KL}(Q || P) \approx 0.292$, demostrando que la divergencia KL no es simétrica. El costo de modelar $P$ con $Q$ no es el mismo que el de modelar $Q$ con $P$.
